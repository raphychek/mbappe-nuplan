...
from nuplan.planning.simulation.planner.ml_planner.mcts_planner import MCTSPlanner
...
def _build_planner(planner_cfg: DictConfig, scenario: Optional[AbstractScenario]) -> AbstractPlanner:
    ...
    if is_target_type(planner_cfg, MLPlanner) or is_target_type(planner_cfg, MCTSPlanner):
